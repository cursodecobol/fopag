      * PAYCHECKS.cbl - Calcula uma folha de pagamento pelas regras 
      * americanas, de forma muito simplificada.
      * Fonte: https://stackoverflow.blog/2020/04/20/brush-up-your-cobol-why-is-a-60-year-old-language-suddenly-in-demand/
      * 
      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT PAYCHECKS ASSIGN TO "PAYCHECKS.DAT"
                   ORGANIZATION IS LINE SEQUENTIAL.
      *
       DATA DIVISION.
       ...
       01 TIMECARD.                                                     
           02 EMPLOYEE-NAME.                      
               03 EMP-FIRSTNAME PIC X(10).                              1     10
               03 EMP-SURNAME   PIC X(15).                              11    25
           02 HOURS-WORKED PIC 99V9.                                    26    28                                 
           02 PAY-RATE     PIC 99.                                      29    30

       FD PAYCHECKS.
       01 PAYCHECKS-FD PIC X(100).
      ...
      * 88 Level is for conditions.
       ...
       INITIALIZE-PROGRAM.
           ...
           DISPLAY '*** STARTING PROGRAM: PAYCHECKS.CBL ***'
           .

       PROCESS-LINE.
           READ TIMECARDS INTO TIMECARD
               AT END MOVE "T" TO END-FILE.
      *     DISPLAY  EMPLOYEE-NAME ' ' HOURS-WORKED ' ' PAY-RATE
           IF NOT EOF THEN
      ...
      * the Federal Insurance Contributions Act and is
      * deducted from each paycheck.
           MULTIPLY GROSS-PAY BY FICA-TAX-RATE GIVING FICA-TAX
           .
       COMPUTE-NET-PAY.
           SUBTRACT FED-TAX STATE-TAX FICA-TAX 
           FROM GROSS-PAY
           GIVING NET-PAY
           .
       PRINT-CHECK.
           ...
           .
       WRITE-CHECK.
           MOVE PAYCHECK TO PAYCHECKS-FD
           WRITE PAYCHECKS-FD
           .
        CLEAN-UP.
           CLOSE TIMECARDS
                 PAYCHECKS
           DISPLAY "*** :END OF PROGRAM: PAYCHECKS.cbl ***"
           .

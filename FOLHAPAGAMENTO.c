...
#define  COB_SOURCE_FILE		"c:\\desenv\\COBOL\\fopag\\FOLHAPAGAMENTO.cbl"
#define  COB_PACKAGE_VERSION		"3.1.2"
#define  COB_PATCH_LEVEL		0
#define  COB_MODULE_FORMATTED_DATE	"dez 05 2022 08:03:56"
#define  COB_MODULE_DATE		20221205
#define  COB_MODULE_TIME		80356

/* Global variables */
#include "FOLHAPAGAMENTO.c.h"

/* Function prototypes */

static int		FOLHAPAGAMENTO ();
static int		FOLHAPAGAMENTO_ (const int);
static void		FOLHAPAGAMENTO_module_init (cob_module *module);
...
/* ENTRY 'FOLHAPAGAMENTO' */

static int
FOLHAPAGAMENTO ()
{
  return FOLHAPAGAMENTO_ (0);
}

static int
FOLHAPAGAMENTO_ (const int entry)
{
  /* Program local variables */
  #include "FOLHAPAGAMENTO.c.l.h"
  ...
  /* Line: 13        : Entry     FOLHAPAGAMENTO          : c:\desenv\COBOL\fopag\FOLHAPAGAMENTO.cbl */
  l_2:;
#line 13 "c:\\desenv\\COBOL\\fopag\\FOLHAPAGAMENTO.cbl"
  ENTRY_FOLHAPAGAMENTO:;
#line 100 "FOLHAPAGAMENTO.c"
#line 14 "c:\\desenv\\COBOL\\fopag\\FOLHAPAGAMENTO.cbl"
  SECTION_MAIN_20SECTION:;
#line 103 "FOLHAPAGAMENTO.c"
#line 14 "c:\\desenv\\COBOL\\fopag\\FOLHAPAGAMENTO.cbl"
  cob_nop ();
#line 106 "FOLHAPAGAMENTO.c"

  /* Line: 14        : DISPLAY            : c:\desenv\COBOL\fopag\FOLHAPAGAMENTO.cbl */
  module->module_stmt = 0x0010000E;
#line 14 "c:\\desenv\\COBOL\\fopag\\FOLHAPAGAMENTO.cbl"
  cob_trace_stmt (st_1);
#line 112 "FOLHAPAGAMENTO.c"
  cob_display (0, 1, 1, &c_1);

  /* Line: 15        : GOBACK             : c:\desenv\COBOL\fopag\FOLHAPAGAMENTO.cbl */
  module->module_stmt = 0x0010000F;
#line 15 "c:\\desenv\\COBOL\\fopag\\FOLHAPAGAMENTO.cbl"
  cob_trace_stmt (st_2);
#line 119 "FOLHAPAGAMENTO.c"
  goto exit_program;
  ...
  FOLHAPAGAMENTO_module_init (module);
...
/* End PROGRAM-ID 'FOLHAPAGAMENTO' */

/* Initialize module structure for FOLHAPAGAMENTO */
static void FOLHAPAGAMENTO_module_init (cob_module *module)
{
  module->module_name = "FOLHAPAGAMENTO";
  module->module_formatted_date = COB_MODULE_FORMATTED_DATE;
  module->module_source = COB_SOURCE_FILE;
  module->module_entry.funcptr = (void *(*)())FOLHAPAGAMENTO;
  module->module_cancel.funcptr = (void *(*)())FOLHAPAGAMENTO_;
